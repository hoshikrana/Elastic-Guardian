...
|---|-----------|------|---------------|---------------|
| 1 | Fibonacci Heap | intelligence/dsa_core.py | O(1) decrease-key | Live re-score under pressure |
| 2 | Red-Black Tree | intelligence/dsa_core.py | O(log n) range | Similar-hardware lookup |
