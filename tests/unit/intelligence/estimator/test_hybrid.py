...
class TestHybridEstimator(unittest.TestCase):
    def test_estimate_vram(self):
        ...
        est = HybridEstimator()
        result = est.estimate_vram(model_params=1_000_000, bytes_per_param=2, gpu=make_gpu(), mode="lora")
    ...
    def test_caching(self):
        ...
        r1 = est.estimate_vram(model_params=500, bytes_per_param=4, gpu=gpu, mode="full")
        r2 = est.estimate_vram(model_params=500, bytes_per_param=4, gpu=gpu, mode="full")
