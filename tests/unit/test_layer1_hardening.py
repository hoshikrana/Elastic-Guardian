...
class TestLayer1Hardening(unittest.TestCase):
    ...
    def test_contract_frozen(self):
        ...
        spec = GPUSpec(
            device_id=0, name="Test GPU", vram_bytes=1000,
            compute_capability=(8,0), memory_bandwidth_gbps=100.0,
            fp16_tflops=10.0, bf16_tflops=10.0,
    ...
    def test_hardware_tier_logic(self):
        ...
        spec = GPUSpec(
            device_id=0, name="Titan", vram_bytes=24 * 1024 * 1024 * 1024,
            compute_capability=(8,6), memory_bandwidth_gbps=900.0,
            fp16_tflops=30.0, bf16_tflops=30.0,
            supports_flash_attn2=True, supports_fp8=False,
            nvlink_peer_ids=()
        )
