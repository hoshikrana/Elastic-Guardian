...
class TestTelemetryAggregation:
    ...
    def test_session_summary(self):
        ...
        summary = {
            ...
            "epochs_completed": sum(1 for e in events if e["event_type"] == "epoch_completed"),
            "status": "completed",
        }
...
class TestPerformanceTelemetry:
    ...
    def test_throughput_degradation(self):
        ...
        degradation = (epoch_throughputs[0] - epoch_throughputs[-1]) / epoch_throughputs[0]
...
class TestTelemetryRetention:
    ...
    def test_old_events_pruned(self):
        ...
        retained = [e for e in events if datetime.fromisoformat(e["timestamp"]) > cutoff]
