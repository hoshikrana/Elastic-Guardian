...
def cluster_topology() -> HardwareTopology:
    ...
    return HardwareTopology(
        ...
        nvme_bytes=8000 * 1024**3,
        nvme_seq_read_gbps=12.0,
        nvme_seq_write_gbps=10.0,
...
def cpu_only_topology() -> HardwareTopology:
    return HardwareTopology(
        ...
        cpu_cores=4,
        ram_bytes=8 * 1024**3,
        nvme_bytes=256 * 1024**3,
        nvme_seq_read_gbps=1.5,
        nvme_seq_write_gbps=1.0,
        pcie_bandwidth_gbps=8.0,
        gpu_interconnect_gbps=0.0,
        interconnect=InterconnectType.PCIE,
        node_count=1,
    )
